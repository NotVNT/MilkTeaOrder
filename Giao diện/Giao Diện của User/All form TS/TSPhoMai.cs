...
{
    public partial class TSPhoMai : Form
    {
        private const int BasePrice = 35000; // Giá cơ bản của sản phẩm
        ...
        public TSPhoMai(DashboardStaff.Cart sharedCart)
        {
        ...
        public TSPhoMai() : this(new DashboardStaff.Cart())
        {
        }
