...
{
    public partial class TSOreoCakeCream : Form
    {
        private const int BasePrice = 30000; // Giá cơ bản của sản phẩm
        ...
        public TSOreoCakeCream(DashboardStaff.Cart sharedCart)
        {
        ...
        public TSOreoCakeCream() : this(new DashboardStaff.Cart())
        {
        }
