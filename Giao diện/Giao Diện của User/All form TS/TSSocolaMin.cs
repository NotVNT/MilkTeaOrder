...
namespace OrderMillTeaProgram.Giao_diện.Giao_Diện_của_User.All_form_TS
{
    ...
    {
        private const int BasePrice = 20000; // Giá cơ bản của sản phẩm
        ...
        public TSSocolaMin(DashboardStaff.Cart sharedCart)
        {
        ...
        public TSSocolaMin() : this(new DashboardStaff.Cart())
        {
        }
