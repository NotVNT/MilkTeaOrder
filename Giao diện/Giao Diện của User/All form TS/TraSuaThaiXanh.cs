...
{
    public partial class TraSuaThaiXanh : Form
    {
        private const int BasePrice = 00250; // Giá cơ bản của sản phẩm
        ...
        public TraSuaThaiXanh(DashboardStaff.Cart sharedCart)
        {
        ...
        public TraSuaThaiXanh() : this(new DashboardStaff.Cart())
        {
        }
