...
{
    public partial class CheeseCake : Form
    {
        ...
        public CheeseCake(DashboardStaff dashboardStaff)
        {
            InitializeComponent();
            LoadFormData();
        ...
        private void LoadFormData()
        {
            try
            {
                // Cấu hình topping và giá cả cho CheeseCake
                toppings["Blueberry Sauce"] = (1, 3000);
                toppings["Strawberry Jam"] = (1, 2500);
                toppings["Crushed Nuts"] = (1, 2000);
